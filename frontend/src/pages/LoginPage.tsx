      ...
      >
        ...
        >
          ...
          <div className="relative flex items-end justify-center" style={{ height: '420px', overflow: 'visible' }}>
            <div style={{ transform: 'scale(0.82)', transformOrigin: 'bottom center' }}>
              <AnimatedCharacters isTyping={isTyping} hasSecret={true} secretVisible={showPassword} />
            </div>
          </div>
        ...
        <div className="flex flex-1 items-center justify-center px-8 py-10">
          <div className="w-full max-w-[360px]">
            ...
            <h1 className="mb-1.5 text-[28px] font-semibold leading-tight text-app-text">欢迎回来</h1>
            <p className="mb-7 text-sm text-app-muted">登录后即可进入 Notifyra 控制台。</p>
